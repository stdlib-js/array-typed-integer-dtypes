...
```javascript
import dtypes from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-integer-dtypes@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-typed-integer-dtypes/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/array-typed-integer-dtypes/actions/workflows/test.yml?query=branch:v0.2.2
